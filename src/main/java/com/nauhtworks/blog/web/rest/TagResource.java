...
import com.nauhtworks.blog.repository.TagRepository;
...
/**
 * REST controller for managing {@link com.nauhtworks.blog.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TagResource {
	...
	public ResponseEntity<Tag> partialUpdateTag(
		...
		log.debug(
			"REST request to partial update Tag partially : {}, {}",
			id,
			tag
		);
		if (tag.getId() == null) {
