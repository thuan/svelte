...
import com.nauhtworks.blog.repository.BlogRepository;
...
/**
 * REST controller for managing {@link com.nauhtworks.blog.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BlogResource {
	...
	public ResponseEntity<Blog> partialUpdateBlog(
		...
		log.debug(
			"REST request to partial update Blog partially : {}, {}",
			id,
			blog
		);
		if (blog.getId() == null) {
