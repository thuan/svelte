package com.nauhtworks.myapp.web.rest.errors;
...
public class ExceptionTranslator
	...
	public ResponseEntity<Problem> handleEmailAlreadyUsedException(
		com.nauhtworks.myapp.service.EmailAlreadyUsedException ex,
		NativeWebRequest request
	) {
	...
	public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
		com.nauhtworks.myapp.service.UsernameAlreadyUsedException ex,
		NativeWebRequest request
	) {
	...
	public ResponseEntity<Problem> handleInvalidPasswordException(
		com.nauhtworks.myapp.service.InvalidPasswordException ex,
		NativeWebRequest request
	) {
